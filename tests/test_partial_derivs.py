...
class TestResidualPartials(unittest.TestCase):
    ...
    def test_fwd_aero_constraint(self):
        ...
        for con_key in ['Elevator']:
            ...
            # print('before', con_key, self.avl_solver.get_avl_fort_arr("CASE_R", "CONVAL", slicer=(0,10)))
            _, res_seeds, _, _ = self.avl_solver.execute_jac_vec_prod_fwd(con_seeds={con_key: 1.0}, geom_seeds={})
            # _, res_seeds, _, _ = self.avl_solver.execute_jac_vec_prod_fwd(con_seeds={con_key: 1.0}, geom_seeds={})
            # print('after', con_key, self.avl_solver.get_avl_fort_arr("CASE_R", "CONVAL", slicer=(0,10)))
