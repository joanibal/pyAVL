...
C   with respect to varying inputs: chordv rc rv1 rv2
C***********************************************************************
C    Module:  aic.f
C 
...
C
C
      SUBROUTINE VVOR_D(betm, iysym, ysym, izsym, zsym, vrcore, nv, rv1
     +                  , rv1_diff, rv2, rv2_diff, nsurfv, chordv, 
     +                  chordv_diff, nc, rc, rc_diff, nsurfc, lvtest, 
...
C
     ...
     +                     rv2_diff(2, j), rv2(3, j), rv2_diff(3, j), 
     +                     rv1(1, j), rv1_diff(1, j), yoff - rv1(2, j), 
     +                     -rv1_diff(2, j), rv1(3, j), rv1_diff(3, j), 
     +                     betm, ui, ui_diff, vi, vi_diff, wi, wi_diff, 
     +                     rcore, rcore_diff)
C
...
C...  Calculate the influence of the z-IMAGE vortex
     ...
     +                     , j), zoff - rv2(3, j), -rv2_diff(3, j), rv1(
     +                     1, j), rv1_diff(1, j), rv1(2, j), rv1_diff(2
     +                     , j), zoff - rv1(3, j), -rv1_diff(3, j), betm
...
C...  Calculate the influence of the y,z-IMAGE vortex
     ...
     +                       rv1(1, j), rv1_diff(1, j), yoff - rv1(2, j)
     +                       , -rv1_diff(2, j), zoff - rv1(3, j), -
     +                       rv1_diff(3, j), rv2(1, j), rv2_diff(1, j), 
     +                       yoff - rv2(2, j), -rv2_diff(2, j), zoff - 
     +                       rv2(3, j), -rv2_diff(3, j), betm, uii, 
